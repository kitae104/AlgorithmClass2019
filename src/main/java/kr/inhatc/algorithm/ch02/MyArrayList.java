package kr.inhatc.algorithm.ch02;
...
public class MyArrayList<T> implements List<T> {
	...
	public MyArrayList() {
		...
		array = (T[]) new Object[10];	// 10개의 요소를 갖는 배열 생성 
		size = 0;						// 처음 요소의 개수는 0
	}
	...
	public int indexOf(Object target) {
		...
		for (int i = 0; i < size; i++) {
			if(equals(target, array[i])) {	// 아래 구현된 equals 사용 
				return i;
			}
		}		
		return -1;
